...
# v1 alias so frontend with baseURL .../api/v1 can call e.g. POST /generate-story
...
# iyzico (Türkiye ödemeleri – ana ödeme kanalı)
from app.routers import iyzico_router
app.include_router(iyzico_router.router, prefix="/api/iyzico", tags=["Payments (iyzico)"])
# Stripe (opsiyonel – legacy)
from app.routers import stripe_router
app.include_router(stripe_router.router, prefix="/api/stripe", tags=["Payments (Stripe)"])
