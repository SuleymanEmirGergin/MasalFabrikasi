    ...
    async def reset_password_with_token(self, token: str, new_password: str) -> bool:
        ...
        async with AsyncSessionLocal() as session:
            try:
                ...
                # expires_at timezone aware olabilir, datetime.utcnow() naive.
                # Burada basitçe karşılaştırma yapıyoruz, model tanımında timezone=True dedik.
                # Pratikte UTC kullanmak en iyisi.
                # Eğer naive ise replace ile düzeltmek gerekebilir ama şimdilik basit tutalım.
    ...
    async def verify_email_with_token(self, token: str) -> bool:
        ...
        async with AsyncSessionLocal() as session:
            try:
                ...
                if verification_record.expires_at.replace(tzinfo=None) < datetime.utcnow():
                    return False
