...
class Settings(BaseSettings):
    ...
    WIRO_TASK_TIMEOUT_SECONDS: int = int(os.getenv("WIRO_TASK_TIMEOUT_SECONDS", "120"))
    ...
    # Stripe (Payments) – legacy, optional
    STRIPE_SECRET_KEY: str = os.getenv("STRIPE_SECRET_KEY", "")
    STRIPE_PUBLISHABLE_KEY: str = os.getenv("STRIPE_PUBLISHABLE_KEY", "")
    STRIPE_WEBHOOK_SECRET: str = os.getenv("STRIPE_WEBHOOK_SECRET", "")

    # iyzico (Payments – Turkey)
    IYZICO_API_KEY: str = os.getenv("IYZICO_API_KEY", "")
    IYZICO_SECRET_KEY: str = os.getenv("IYZICO_SECRET_KEY", "")
    IYZICO_BASE_URL: str = os.getenv("IYZICO_BASE_URL", "sandbox-api.iyzipay.com")  # Canlı: api.iyzipay.com
