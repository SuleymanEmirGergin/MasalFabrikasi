...
**Not:** Görsel yükleme ve dosya depolama ana olarak **Supabase Storage** kullanır. Cloudinary opsiyonel alternatiftir; `USE_CLOUD_STORAGE` ve Cloudinary env değişkenleri ile etkinleştirilebilir. Magic Canvas ve diğer görsel akışları varsayılan olarak Supabase Storage kullanır.
